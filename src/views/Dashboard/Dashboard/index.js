...
export default function Dashboard() {
  ...
  return (
    <Grid templateColumns="repeat(2, 1fr)" gap={2} pt={{ base: "120px", md: "75px" }}>
      <Box bg="#fff" p={4} color="black" borderRadius="lg" boxShadow="md" width="100%">
      ...
      <Box bg="#fff" p={4} color="black" borderRadius="lg" boxShadow="md" width="100%" >
        <Flex justifyContent="space-between" alignItems="center" pt="14px">
          ...
          <Text textDecor="bold"> 124 </Text>
          <Text size="md"> Sensor Point </Text>
          <Button bg="#00DC7F" color="white" _hover="none" width="77px" height="29px" borderRadius="lg">
            Active
          </Button>
        </Flex>
      </Box>
